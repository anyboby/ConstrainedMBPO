params = {
    ...
    'kwargs': {
        ...
        'model_train_freq': 250,        # model is only trained every (self._timestep % self._model_train_freq==0) steps (terminates when stops improving)
        ...
        'rollout_schedule': [50, 300, 1, 1], #[15, 100, 1, 15],    # min_epoch, max_epoch, min_length, max_length = self._rollout_schedule
