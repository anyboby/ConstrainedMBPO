params = {
    ...
    'kwargs': {
        ...
        'rollout_schedule': [5, 150, 15, 35], #[15, 100, 1, 15],    # min_epoch, max_epoch, min_length, max_length = self._rollout_schedule
                                                    # increases rollout length from min_length to max_length over 
                                                    # range of (min_epoch, max_epoch)
        'max_tddyn_err' : 0.01,
        'max_tddyn_err_decay' : .95,
        'batch_size_policy': 10e3,              ### how many samples 
