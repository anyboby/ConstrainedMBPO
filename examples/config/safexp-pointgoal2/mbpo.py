params = {
    ...
    'kwargs': {
        ...
        'hidden_dim':150,               # hidden layer size of model bnn
        ...
        'rollout_schedule': [15, 200, 1, 15], #[15, 100, 1, 15],    # min_epoch, max_epoch, min_length, max_length = self._rollout_schedule
