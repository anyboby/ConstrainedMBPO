params = {
    ...
    'max_pool_size':int(8e5),           # maximum pool size for model training, if memory is an issue
    ...
    'kwargs': {
        ...
        'n_train_repeat': 15, #20 #40,      # -> refers to total timesteps
        ...
        'hidden_dim':360,               # hidden layer size of model bnn
        ...
        'rollout_schedule': [30, 200, 1, 10], #[15, 100, 1, 15],    # min_epoch, max_epoch, min_length, max_length = self._rollout_schedule
