params = {
    ...
    'kwargs': {
        ...
        'epoch_length': 10000, #1000,    # samples per epoch, also determines train frequency 
        ...
        'rollout_batch_size': 20e3,    # rollout_batch_size is the size of randomly chosen states to start from when rolling out model
        'deterministic': False,          
