...
class FakeEnv:
    ...
    def __init__(self, true_environment, policy,
        ...
        #                                 # min_logvar=-10,
        #                                 session=self._session)  
        # self._model2 = construct_model(in_dim=input_dim_dyn, 
        #                                 out_dim=output_dim_dyn,
        #                                 name='DynamicsNN2',
        #                                 loss='MSE',
        #                                 hidden_dims=hidden_dims,
        ...
        # self._model3 = construct_model(in_dim=input_dim_dyn, 
        #                                 out_dim=output_dim_dyn,
        #                                 name='DynamicsNN3',
        #                                 loss='MSE',
        #                                 hidden_dims=hidden_dims,
        ...
        #                                 # min_logvar=-10,
        #                                 session=self._session)  
        # self._model4 = construct_model(in_dim=input_dim_dyn, 
        #                                 out_dim=output_dim_dyn,
        #                                 name='DynamicsNN4',
        #                                 loss='MSE',
        #                                 hidden_dims=hidden_dims,
        ...
        #                                 # min_logvar=-10,
        #                                 session=self._session)  
        # self._model5 = construct_model(in_dim=input_dim_dyn, 
        #                                 out_dim=output_dim_dyn,
        #                                 name='DynamicsNN5',
        #                                 loss='MSE',
        ...
        # self._model6 = construct_model(in_dim=input_dim_dyn, 
        #                                 out_dim=output_dim_dyn,
        #                                 name='DynamicsNN6',
        #                                 hidden_dims=(256,256,256),
        #                                 lr=3e-3, 
        ...
        # self._model7 = construct_model(in_dim=input_dim_dyn, 
        #                                 out_dim=output_dim_dyn,
        #                                 name='DynamicsNN7',
        #                                 loss='MSE',
        ...
        #                                 # min_logvar=-10,
        #                                 session=self._session)                                          
        # self._model8 = construct_model(in_dim=input_dim_dyn, 
        #                                 out_dim=output_dim_dyn,
        #                                 name='DynamicsNN8',
        #                                 loss='MSE',
        #                                 hidden_dims=(384, 384, 384),
        ...
        # self._model9 = construct_model(in_dim=input_dim_dyn, 
        #                                 out_dim=output_dim_dyn,
        #                                 name='DynamicsNN9',
        #                                 loss='MSE',
        #                                 hidden_dims=(384, 384, 384),
        ...
        #                                 # min_logvar=-10,
        #                                 session=self._session)                                          
        # self._model10 = construct_model(in_dim=input_dim_dyn, 
        #                                 out_dim=output_dim_dyn,
        #                                 name='DynamicsNN10',
        #                                 loss='MSE',
        #                                 hidden_dims=(312, 312, 312),
        #                                 lr=8e-4, 
        #                                 decay=1e-7,
        #                                 # lr_decay=0.96,
        #                                 # decay_steps=10000,  
        ...
        # self._model11 = construct_model(in_dim=input_dim_dyn, 
        #                                 out_dim=output_dim_dyn,
        #                                 name='DynamicsNN11',
        #                                 loss='MSE',
        #                                 hidden_dims=(312, 312, 312),
        ...
        #                                 # min_logvar=-10,
        #                                 session=self._session)                                          
        # self._model12 = construct_model(in_dim=input_dim_dyn, 
        #                                 out_dim=output_dim_dyn,
        #                                 name='DynamicsNN12',
        #                                 loss='MSE',
        #                                 hidden_dims=(312, 312, 312),
        ...
        #                                 # min_logvar=-10,
        #                                 session=self._session)                                          
        # self._model13 = construct_model(in_dim=input_dim_dyn, 
        #                                 out_dim=output_dim_dyn,
        #                                 name='DynamicsNN13',
        #                                 loss='Huber',
        #                                 hidden_dims=(256, 256, 256),
        ...
        #                                 # min_logvar=-10,
        #                                 session=self._session)                 
        # self._model14 = construct_model(in_dim=input_dim_dyn, 
        #                                 out_dim=output_dim_dyn,
        #                                 name='DynamicsNN14',
        #                                 loss='Huber',
        #                                 hidden_dims=(256, 256, 256),
        ...
        #                                 # min_logvar=-10,
        #                                 session=self._session)                                          
        # self._model15 = construct_model(in_dim=input_dim_dyn, 
        #                                 out_dim=output_dim_dyn,
        #                                 name='DynamicsNN15',
        #                                 loss='Huber',
        #                                 hidden_dims=(256, 256, 256),
        ...
        # self._model16 = construct_model(in_dim=input_dim_dyn, 
        #                                 out_dim=output_dim_dyn,
        #                                 name='DynamicsNN16',
        #                                 loss='Huber',
        #                                 hidden_dims=(312, 312, 312),
        ...
        #                                 # min_logvar=-10,
        #                                 session=self._session)                                          
        # self._model17 = construct_model(in_dim=input_dim_dyn, 
        #                                 out_dim=output_dim_dyn,
        #                                 name='DynamicsNN17',
        #                                 loss='Huber',
        #                                 hidden_dims=(312, 312, 312),
        ...
        #                                 # min_logvar=-10,
        #                                 session=self._session)                                          
        # self._model18 = construct_model(in_dim=input_dim_dyn, 
        #                                 out_dim=output_dim_dyn,
        #                                 name='DynamicsNN18',
        #                                 loss='Huber',
        #                                 hidden_dims=(312, 312, 312),
        ...
        #                                 # min_logvar=-10,
        #                                 session=self._session)                                          
        # self._model19 = construct_model(in_dim=input_dim_dyn, 
        #                                 out_dim=output_dim_dyn,
        #                                 name='DynamicsNN19',
        #                                 loss='Huber',
        #                                 hidden_dims=hidden_dims,
        ...
        #                                 # min_logvar=-10,
        #                                 session=self._session)                                          
        # self._model20 = construct_model(in_dim=input_dim_dyn, 
        #                                 out_dim=output_dim_dyn,
        #                                 name='DynamicsNN20',
        #                                 loss='Huber',
        #                                 hidden_dims=hidden_dims,
        ...
        #                                 # min_logvar=-10,
        #                                 session=self._session)                                          
        # self._model21 = construct_model(in_dim=input_dim_dyn,  
        #                                 out_dim=output_dim_dyn, 
        #                                 name='DynamicsNN21', 
        #                                 loss='Huber', 
        #                                 hidden_dims=hidden_dims, 
    ...
    def train_dyn_model(self, samples, **kwargs):
        ...
        # model_metrics2 = self._model2.train(train_inputs_dyn, 
        #                                     train_outputs_dyn, 
        #                                     **kwargs,
        #                                     )
        # model_metrics3 = self._model3.train(train_inputs_dyn, 
        #                                     train_outputs_dyn, 
        #                                     **kwargs,
        #                                     )
        # model_metrics4 = self._model4.train(train_inputs_dyn, 
        #                                     train_outputs_dyn, 
        #                                     **kwargs,
        #                                     )
        # model_metrics5 = self._model5.train(train_inputs_dyn, 
        #                                     train_outputs_dyn, 
        #                                     **kwargs,
        #                                     )
        # model_metrics6 = self._model6.train(train_inputs_dyn, 
        #                                     train_outputs_dyn, 
        #                                     **kwargs,
        #                                     )
        # model_metrics7 = self._model7.train(train_inputs_dyn, 
        #                                     train_outputs_dyn, 
        #                                     **kwargs,
        #                                     )
        # model_metrics8 = self._model8.train(train_inputs_dyn, 
        #                                     train_outputs_dyn, 
        #                                     **kwargs,
        #                                     )
        # model_metrics9 = self._model9.train(train_inputs_dyn, 
        #                                     train_outputs_dyn, 
        #                                     **kwargs,
        #                                     )
        # model_metrics10 = self._model10.train(train_inputs_dyn, 
        #                                     train_outputs_dyn, 
        #                                     **kwargs,
        #                                     )
        # model_metrics11 = self._model11.train(train_inputs_dyn, 
        #                                     train_outputs_dyn, 
        #                                     **kwargs,
        #                                     )
        # model_metrics12 = self._model12.train(train_inputs_dyn, 
        #                                     train_outputs_dyn, 
        #                                     **kwargs,
        #                                     )
        # model_metrics13 = self._model13.train(train_inputs_dyn, 
        #                                     train_outputs_dyn, 
        #                                     **kwargs,
        #                                     )
        # model_metrics14 = self._model14.train(train_inputs_dyn, 
        #                                     train_outputs_dyn, 
        #                                     **kwargs,
        #                                     )
        # model_metrics15 = self._model15.train(train_inputs_dyn, 
        #                                     train_outputs_dyn, 
        #                                     **kwargs,
        #                                     )
        # model_metrics16 = self._model16.train(train_inputs_dyn, 
        #                                     train_outputs_dyn, 
        #                                     **kwargs,
        #                                     )
        # model_metrics17 = self._model17.train(train_inputs_dyn, 
        #                                     train_outputs_dyn, 
        #                                     **kwargs,
        #                                     )
        # model_metrics18 = self._model18.train(train_inputs_dyn, 
        #                                     train_outputs_dyn, 
        #                                     **kwargs,
        #                                     )
        # model_metrics19 = self._model19.train(train_inputs_dyn, 
        #                                     train_outputs_dyn, 
        #                                     **kwargs,
        #                                     )
        # model_metrics20 = self._model20.train(train_inputs_dyn, 
        #                                     train_outputs_dyn, 
        #                                     **kwargs,
        #                                     )
        # model_metrics21 = self._model21.train(train_inputs_dyn, 
        #                                     train_outputs_dyn, 
        #                                     **kwargs,
        #                                     )
