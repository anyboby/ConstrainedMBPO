...
def safety_gym_weights(obs_dim):
    ...
    mse_weights[0:2] = 0.01    # predicting prev action given the action should be easy, but has very high unnormalized target values. 
    mse_weights[3:19]=1 # goal lidar
    mse_weights[2]=1   # goal dist.
    mse_weights[-1]= 0.01   # rew function
