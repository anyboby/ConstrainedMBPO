...
class StaticFns:
    ...
    def termination_fn(obs, act, next_obs, safe_config):
        ...
        done = np.vectorize(StaticFns._goal_met)(goal_dist)
        #done = done[:,None]
        return done
